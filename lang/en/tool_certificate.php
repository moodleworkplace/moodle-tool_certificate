...
$string['certificate:viewallcertificates'] = 'View all certificates for the current tenant';
$string['certificate:verifyallcertificates'] = 'Verify all certificates on the site for all tenants';
