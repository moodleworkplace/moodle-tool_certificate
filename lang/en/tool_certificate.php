...
$string['availableincourses_help'] = 'If this option is selected, then users who can issue certificates in sub-categories and courses in the selected category will be able to use this template. Otherwise it can only be used by users in selected category';
