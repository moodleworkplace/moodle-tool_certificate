...
/**
 * Unit tests for studentname element.
 *
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class tool_certificate_studentname_element_test_testcase extends advanced_testcase {
    ...
    public function test_render_html_content() {
        ...
        $element = $certificate1->new_element_for_page_id($pageid, 'studentname');
